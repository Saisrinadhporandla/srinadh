...
@Test
public class Removing_ItemsFrom_Cart {
	public static void main(String[] args) throws InterruptedException {
		...
		dr.findElement(By.xpath("//div[@id='nav-cart-text-container']")).click();
		dr.findElement(By.cssSelector("span[class='a-size-small sc-action-delete']")).click();
	}
